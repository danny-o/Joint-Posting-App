...
class ExampleInstrumentedTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.digitalskies.postingapp", appContext.packageName)
        ...
        val encrypted=cipher.doFinal(Base64.decode(deccrypted,Base64.DEFAULT))

        cipher2.init(Cipher.DECRYPT_MODE, skey, IvParameterSpec(CRYPT_IV.toByteArray()));

        println("encrypted $encrypted")

        println(cipher2.doFinal(encrypted))
